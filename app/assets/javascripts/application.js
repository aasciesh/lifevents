...
// function triggerAjaxSearch(query) {
...
// 	clearTimeout(thread);
// 	var $this = $(this); thread = setTimeout(function(){triggerAjaxSearch($this.val())}, 100);
// });
...
$(document).ready( function(){
	...
	$('#search').focus(function() {
		if ($("#search").val() == "Search events, people.." ){
	...
	$('#search').blur(function() {
		if ($("#search").val().trim() == ""){
			...
			$("#search").val("Search events, people..");
		}
	...
	$('form.new_event').bind('ajax:success', function(xhr, data, status) {
		...
		if (data.message == "saved")
		{
			...
			$("div[data-no='"+eventsNo+"']").effect("highlight", {}, 5000);
